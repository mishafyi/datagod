...
| **`newsnow.py`** | NewsNow (self-hosted, image pinned `v0.0.41`) — ~50 trending/hot boards: HN, GitHub trending, Product Hunt, Weibo/Zhihu/Douyin hot searches, CN finance wires | `/trending`, `/trending/{source_id}` | `docs/NEWSNOW_API.md` | `NEWSNOW_BASE_URL` (required; Coolify-internal `http://newsnow:4444`) |
