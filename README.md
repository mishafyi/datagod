...
- `docs/API_GUIDE.md` — **which endpoint for which information** (routing map + one-liner per endpoint); `docs/endpoints.csv` is the same list for tooling. Generated by `scripts/gen_api_guide.py`.
